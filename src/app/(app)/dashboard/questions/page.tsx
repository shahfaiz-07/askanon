...
const Page = () => {
  ...
  useEffect(() => {
    const fetchUserQuestions = async() => {
      setLoading(true)
      try {
        const response = await axios.get<ApiResponse>('/api/get-questions-received');
        ...
        toast({
            title: "Error",
            description: "Error fetching questions received",
            variant: "destructive",
        });
      }
      setLoading(false)
  ...
  return loading ? (
      ...
      <div className="min-h-screen mb-5">
          <div className="flex justify-between items-center p-5 md:px-10 lg:px-14">
              <h1 className="text-xl md:text-3xl font-bold ">Questions</h1>
      ...
      <div className="flex items-center justify-center min-h-screen p-4">
          <h1 className="max-w-[500px]">
              No questions in your inbox. Share your AskAnon public account link
              to receive questions. And don't forget to set the Accept Questions
              Flag
          </h1>
      </div>
  );
